...
from support.alpha_vantage_api import get_sma, get_ema, RequestType, AVRequest, get_intraday
...
class WatcherNode(BaseNode):
    ...
    def _process_task(self, task):
        ...
        if r.type is RequestType.SMA50:
            data = get_sma(
                r.symbol, r.key, interval, time_period=50, series_type=series
            )
        elif r.type is RequestType.SMA200:
            data = get_sma(
                r.symbol, r.key, interval, time_period=200, series_type=series
            )
